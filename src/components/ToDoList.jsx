  ...
  return (
    <div className="flex flex-col items-center bg-slate-300 m-4 rounded-3xl p-4 w-1/2 mx-auto">
      ...
      <div className="flex m-2 justify-between space-x-3">
        ...
        <button className="text-sm px-2 py-1 mx-1 bg-blue-500 text-white rounded disabled:bg-gray-300">
          Add
        </button>
      </div>
      <ul className="m-4 p-4  w-1/2">
        <li className="p-2 border border-gray-400 rounded-lg text-stone-800 text-xl  w-full">tets</li>
      </ul>
    </div>
  );
}
